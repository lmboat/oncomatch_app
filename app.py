...
def load_data():
    ...
    return df_cancer_gene, df_gene_drug, df_proteomics, drug_name_to_smiles


# Load the data with caching
df_cancer_gene, df_gene_drug, df_proteomics, drug_name_to_smiles = load_data()
...
selected_drugs = st.multiselect(
    "Select drugs to analyze similarities:", sorted(drugs_with_proteomics)
)
...
if selected_drugs:
    ...
    drugs_with_smiles = [d for d in selected_drugs if d in drug_name_to_smiles]
    similar_drugs_with_smiles = [d for d in similar_drugs if d in drug_name_to_smiles]
